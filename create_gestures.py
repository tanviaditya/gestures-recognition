...
#	if cam.read()[0]==False:
	...
	#Create the folder for the first image.
	create_folder("gestures/"+str(g_id))
	#Which image are we capturing?
	pic_no=0
	#Have we begun capturing? No.
	...
	while True:
		...
		#If we press 'c', toggle between capturing states.
		if keypress==ord('c'):
